...
struct mem : public sc_module {
    ...
    sc_signal< sc_lv<1> > re_read_reg_133;
    sc_signal< sc_lv<1> > re_read_reg_133_pp0_iter1_reg;
    sc_signal< sc_lv<1> > re_read_reg_133_pp0_iter2_reg;
    sc_signal< sc_lv<1> > we_read_reg_137;
    sc_signal< sc_lv<1> > we_read_reg_137_pp0_iter1_reg;
    sc_signal< sc_lv<1> > we_read_reg_137_pp0_iter2_reg;
    sc_signal< sc_lv<7> > addr_read_reg_141;
    sc_signal< sc_lv<7> > addr_read_reg_141_pp0_iter1_reg;
    sc_signal< sc_lv<7> > addr_read_reg_141_pp0_iter2_reg;
    sc_signal< sc_lv<7> > saved_addr_reg_147;
    sc_signal< sc_lv<7> > saved_addr_reg_147_pp0_iter1_reg;
    sc_signal< sc_lv<7> > saved_addr_reg_147_pp0_iter2_reg;
    sc_signal< sc_lv<8> > temp_reg_153;
    sc_signal< sc_lv<8> > temp_1_fu_91_p2;
    sc_signal< sc_lv<8> > temp_1_reg_158;
    sc_signal< bool > ap_block_pp0_stage0_subdone;
    sc_signal< sc_lv<64> > zext_ln8_fu_86_p1;
    sc_signal< bool > ap_block_pp0_stage0;
    sc_signal< sc_lv<1> > icmp_ln14_fu_109_p2;
    sc_signal< sc_lv<8> > zext_ln32_fu_100_p1;
    sc_signal< bool > ap_block_pp0_stage0_01001;
    sc_signal< sc_lv<8> > zext_ln18_fu_124_p1;
    sc_signal< sc_lv<8> > zext_ln22_fu_128_p1;
    ...
    void thread_icmp_ln14_fu_109_p2();
    void thread_out_r();
    ...
    void thread_temp_1_fu_91_p2();
    void thread_zext_ln18_fu_124_p1();
    void thread_zext_ln22_fu_128_p1();
    void thread_zext_ln32_fu_100_p1();
